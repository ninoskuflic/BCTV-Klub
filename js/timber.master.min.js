...
! function(a, b, c, d) {
    ...
    function g(b, c, d, e) {
        ...
        if (s(b, d), r(f, d), d.carousel && !d.lazyLoad && (g.children().css({
            ...
            F ? (clearTimeout(k), k = setTimeout(function() {
                ...
                opacity: 1
            }), l && !M || (clearTimeout(j), j = setTimeout(function() {
                i.find(".tms-caption").length > 0 && o(i, d), i.find(".tms-content-scalable").length > 0 && a(".tms-content-scalable").css({
                    opacity: 1
                })
            }, 300))
        } else c === g.children().length && ((f.find(".tm-loader").length && !l || M) && h(f, b, d), i.find(".tms-caption").show(), d.carouselVisible > 1 && f.find(".tms-caption").show(), F ? d.carousel ? m(g, 1, 0, 0, 0, 0, 0, 0, 1, "50%", "50%", 1e3, 0, "easeIn", d) : m(i, 1, 0, 0, 0, 0, 0, 0, 1, "50%", "50%", 1e3, 0, "easeIn", d) : d.carousel ? g.animate({
            opacity: 1
        }) : i.animate({
            opacity: 1
        }), l && !M || (clearTimeout(j), j = setTimeout(function() {
    ...
    var i = function(d, g) {
            ...
            if (i.navPagination && y.children().length > 1) {
                ...
                }), I.children().eq(o.find("li.active").index()).addClass("active"), i.lazyLoad && I.css({
                    display: "block"
                })
            }
            ...
            t.initSlideshow = function() {
                ...
                return !(T || !O) && (clearInterval(O), Q = (new Date).getTime(), R = S - (Q - P) < 50 ? 50 : S - (Q - P), S = 0 === S ? i.interval : R, "undefined" != typeof U && U.stop().css({
                    width: U.width() + "px"
                }), T = !0, void(i.onSlideshowPause && i.onSlideshowPause()))
        ...
        m = function(b, c, d, e, f, g, h, i, j, k, l, m, o, p, q) {
            ...
            s.transform = "translate3d(" + d + "px, " + e + "px, " + f + "px) rotateX(" + g + "deg) rotateY(" + h + "deg) rotateZ(" + i + "deg) scale3d(" + j + ", " + j + ", " + j + ")", s.transitionProperty = I + ", opacity", s.transformOrigin = k + " " + l + " 0", s.transitionDuration = m + "ms", s.transitionDelay = o + "ms", s.transitionTimingFunction = p, s.visibility = "visible", s.opacity = c, b.css(s).on(J, function(b) {
                b.stopPropagation(), a(this).off(J), (a(this).hasClass("target") || a(this).hasClass("tms-slides") && !r.data("animate-first-slide")) && n(r, q), a(this).hasClass("tms-caption") && a(this).css({
                    transition: ""
        ...
        n = function(a, b) {
            ...
            return v(c, "pause", b), 1 === b.carouselVisible && c.find(".tms-caption").not(".no-transition").css({
                ...
                visibility: "hidden"
            }), c.removeClass("active"), d.removeClass("target").addClass("active"), c = d, b.onSlideAfter && b.onSlideAfter(), v(c, "play", b), !(b.carouselVisible > 1) && void(e && !M || o(c, b))
        },
        o = function(b, c) {
        ...
        A = function(d, e, f, g) {
            ...
            if (e.attr("id", "video-" + l.getTime()), "undefined" != typeof j && j.indexOf("vimeo") > -1) {
                if (e.attr("src", e.attr("src").replace("?api=1", "") + "?&amp;player_id=" + e.attr("id")).addClass("vimeo"), i.is("[data-video-bkg-vimeo]") && e.attr("src", e.attr("src") + "&autoplay=0&amp;title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;background=1").addClass("vimeo"), !y) {
                    y = !0;
    ...
    var C, D = b.body || b.documentElement,
        E = D.style,
...
! function(a, b, c, d) {
    ...
    var e = function(d, e) {
            ...
            }) : (h(d, g), d.data("startup", !0).data("orignDistance", j).css({
                width: "100%",
                display: "flex",
...
$(document).ready(function() {
    ...
    var a = ".header",
        ...
        Ia = {
            init: function() {
                $(Ba).removeClass("no-js"), Ia.siteHeader(), Ia.retinize(), Ia.equalize(768), Ia.parallax(".parallax", !0, !1, !0), Ia.fullScreenSection(), Ia.masonry(), Ia.logoSlider(), Ia.heroSlider(), Ia.testimonialSlider(), Ia.teamSlider(), Ia.recentSlider(), Ia.carouselSlider(), Ia.contentSlider(), Ia.fullScreenSlider(), Ia.fullWidthSlider(), Ia.sliderAuxNav(), Ia.lightbox(), Ia.counter(".stat", ".stat-counter", !1), Ia.countdown(".countdown"), Ia.horizon(".horizon", ".parallax .horizon", "easeInOutQuint", !1, 1), Ia.freeze(".freeze"), Ia.videos(), Ia.mediaElement(), Ia.signupForm(), Ia.contactForm(), Ia.enablePlaceHolder();
                try {
                    document.getElementsByClassName("map-canvas") && google.maps.event.addDomListener(window, "load", Ia.googleMap)
                } catch (a) {}
                Ia.fixedFooter(), Ia.pageFade(), Ia.scrollToSection(), Ia.socialize(), $("body").hasClass("preload-page") && Ia.preloadPage()
            },
            retinize: function() {
                $(i).retinizeImages()
            },
            ...
            siteHeader: function() {
                ...
                var w = function(b) {
                        return !($("body").hasClass("mobile") || j < t) && (o && $(b).scrollTop() >= o || 0 === o ? ($(a).addClass(c), p && q && $(a).addClass(h)) : ($(a).removeClass(c), p && q && $(a).removeClass(h)), m && $(b).scrollTop() >= m ? $(a).addClass(d) : $(a).removeClass(d), n && $(b).scrollTop() >= n ? $(a).addClass(e) : $(a).removeClass(e), r = $(b).scrollTop(), r > s ? (p && $(b).scrollTop() >= p && $(a).addClass(f), $(a).removeClass(g)) : r < s && (p && $(b).scrollTop() <= p && ($(a).removeClass(f), $(a).removeClass(g)), p && $(b).scrollTop() >= p && $(b).scrollTop() <= q && ($(a).addClass(g), $(g).on(Ha, function(c) {
            ...
            masonry: function() {
                $(q).each(function() {
                    ...
                    if (c.hasClass("fade-in-progressively") && d.children().addClass("no-transition"), "*" !== e && ($(s).find(".active").removeClass("active"), $(s).find('[data-filter="' + e + '"]').addClass("active")), c.data("layout-mode")) {
                        a = c.data("layout-mode") ? c.data("layout-mode") : "masonry", c.is("[data-layout-mode]") && c.addClass("masonry"), c.is("[data-set-dimensions]") && c.addClass("masonry-set-dimensions"), v = !!c.is("[data-animate-resize]"), u = c.is("[data-animate-resize-duration]") ? c.data("animate-resize-duration") + "ms" : u, c.is(".masonry-set-dimensions, .masonry-set-dimensions-2") ? (c.is(".full-width.no-margins") && Ia.masonryWrapperWidth(c, d), b = Ia.masonryColWidth(c, d), Ia.masonryThumbSizes(c, d, Ia.masonryColWidth(c, d))) : b = ".grid-sizer";
                        ...
                        g.appendTo(c), imagesLoaded(d, function() {
                            ...
                            d.children().each(function(a) {
                                ...
                                c.removeClass("fade-in-progressively"), c.is(".full-width.no-margins") && Ia.masonryWrapperWidth(c, d), Ia.masonryThumbSizes(c, d, Ia.masonryColWidth(c, d)), v ? d.isotope({
            ...
            signupForm: function() {
                $(S).submit(function(a) {
                    ...
                    if (T = T.split(".").join(""), d.removeClass(T), d.each(function() {
                        ...
                        }), k || (l = !0), e.val() && !Ia.isValidEmail(e.val()) ? (c.hide().text(Z).fadeIn(200), e.addClass(T)) : m = !0, "" !== f.val()) return !1;
                    if (k && e.val() && !Ia.isValidEmail(e.val()) && c.hide().text(Y + " " + Z).fadeIn(200), l && m) {
                        var n = $(g).val();
                        $(g).css({
            ...
            contactForm: function() {
                $(_).submit(function(a) {
                    ...
                    if (aa = aa.split(".").join(""), d.removeClass(aa), d.each(function() {
                        ...
                        }), o || (p = !0), e.val() && !Ia.isValidEmail(e.val()) ? (c.hide().text(ga).fadeIn(200), e.addClass(aa)) : q = !0, "" !== f.val()) return !1;
                    if (o && e.val() && !Ia.isValidEmail(e.val()) && c.hide().text(fa + " " + ga).fadeIn(200), p && q) {
                        var r = $(g).val();
                        $(g).css({
                            width: $(g).outerWidth() + "px"
                ...
                return !!Aa && void $(Ca).each(function() {
                    "_blank" === $(this).attr("target") && $(this).addClass("no-page-fade"), $(this).not(Da).on("click", function(a) {
                        ...
                        $("body").hasClass("transition-support") ? $(Ba).addClass("page-fade-out").on(Ha, function(a) {
                            return a.stopPropagation(), a.target === $(this)[0] && void Ia.goToNewPage(b)
                        }) : Ia.goToNewPage(b)
                    })
                })
            },
